...
var handlePressDeleteFavorite = async (_id) => {
    ...
    const deleteReq = await fetch('http://172.17.1.32:3000/delete-favorites', {
        method: 'POST',
    ...
    useEffect(() => {
        ...
        const findFavorites = async () => {
            const dataFavorites = await fetch(`http://172.17.1.32:3000/favorites?token=${props.dataUser.token}`)
