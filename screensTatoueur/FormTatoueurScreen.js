            ...
            <>
              <View style={{ flexDirection: "row", alignSelf: "center" }}>
                ...
                <TouchableOpacity onPress={() => Refuse()}>
                  <Text>
                    <Entypo name="cross" size={30} color="#FF0000" />
                  </Text>
                </TouchableOpacity>
              </View>
            </>
          ) : status == "Accepté" ? (
            <Text style={{ textAlign: "center", color: "#008000" }}>
              {" "}
              {status}{" "}
            </Text>
          ) : (
              ...
              <View style={styles.modalView}>
                ...
                <View style={styles.continuer}>
                  <Text style={styles.text}>
                    {" "}
                    Veuillez cliquer sur le bouton ci-dessous pour confirmer le
                    refus
                  </Text>
                  <Button
...
export default connect(mapStateToProps, null)(FormTatoueurScreen);
